module GenreSelectCss exposing (..)
...
css =
    (stylesheet << namespace "multiselect")
        ...
        , class Container
            [ Css.border3 (px 1) solid primaryColor
        ...
        , class TagIcon
            [ Css.hover [ Css.backgroundColor backgroundColor ] -- todo: hover color
            , Css.cursor Css.pointer
            , Css.borderRight3 (px 1) solid primaryColor
        ...
        , class Menu
            ...
            , Css.backgroundColor backgroundColor
            , Css.border3 (px 1) Css.solid primaryColor
            , Css.borderTopColor primaryColor
