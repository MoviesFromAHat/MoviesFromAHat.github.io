	...
	function (available, selected) {
		return function (m) {
			return _elm_lang$core$Native_Utils.update(
				m,
				{
					selected: _elm_lang$core$Set$toList(selected)
				});
		}(
			function (m) {
...
var _user$project$Genre$toCapital = function (str) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _user$project$Genre$fromFlatList = function (genres) {
	return _elm_lang$core$Set$fromList(
		A2(
			_elm_lang$core$List$map,
			function (g) {
				return {
					ctor: '_Tuple2',
					_0: g,
					_1: _user$project$Genre$toCapital(g)
				};
			},
			genres));
};
var _user$project$Genre$fromQueryString = function (location) {
	return _user$project$Genre$fromFlatList(
		A2(
			_elm_lang$core$List$filter,
			function (g) {
				return !_elm_lang$core$String$isEmpty(g);
			},
			A2(
				_elm_lang$core$String$split,
				'+',
					...
					A2(
						...
						A2(
							...
							A2(
								...
								_evancz$url_parser$UrlParser$stringParam('genres')),
							location))))));
};
...
var _user$project$MovieList$movies = A2(
	...
	function (m) {
		return _elm_lang$core$Native_Utils.update(
			m,
			{
				genres: _user$project$Genre$fromFlatList(m.genres)
			});
	},
	{
		ctor: '::',
				...
				return {
					...
					_1: A2(
						...
						_elm_community$random_extra$Random_List$choose(
							A2(
								_elm_lang$core$List$filter,
								_user$project$Movie$matchGenres(model.selectedGenres),
								model.unwatched)))
				};
			case 'MovieSelected':
			...
			default:
				...
				var newUrl = function () {
					...
					if (_p5 === 0) {
						...
						return A2(
							...
							A2(_elm_lang$core$Basics_ops['++'], model.location.origin, '?genres='),
							A2(
								_elm_lang$core$String$join,
								'+',
								A2(
				...
				return A2(
						...
						{genresMultiselect: subModel, selectedGenres: selectedGenres}),
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$navigation$Navigation$modifyUrl(newUrl),
							_1: {ctor: '[]'}
						}
					});
		}
